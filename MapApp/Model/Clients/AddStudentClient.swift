...
class AddStudentClient{
    ...
    class func postStudentLocation(newLocation: String, newURL: String, newLatitude: Double, newLongitude: Double, completion: @escaping (Bool, Error?) -> Void) {
        ...
        let addJSON = resultsResponse(firstName: "Bugs", lastName: "Bunny", longitude: newLongitude, latitude: newLatitude, mapString: newLocation, mediaURL: newURL, uniqueKey: "12211", objectId: nil, createdAt: nil, updatedAt: nil)
